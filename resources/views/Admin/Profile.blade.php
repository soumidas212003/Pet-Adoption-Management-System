...
<div class="container-xl px-4 mt-4">
    ...
    <nav class="nav nav-borders">
        <a class="nav-link active ms-0" href="{{route('admin.home')}}" target="__blank">Back To Dashboard</a>
    </nav>
    <hr class="mt-0 mb-4">
    <div class="row">
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    <form action="">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" src="{{asset('admin-assests/img/ruban.jpg')}}" alt="">
                        <!-- Profile picture help block-->
                        <div class="small font-italic text-muted mb-4">JPG or PNG no larger than 5 MB</div>
                        <!-- Profile picture upload button-->
                        <input class="btn btn-primary" type="file"></input>
