...
<div class="flex justify-center items-start mt-8 mb-7"> <!-- Adjusted flex and items properties here -->
    <div class="bg-white shadow appearance-none border rounded h-96 w-72 md:w-[40rem] lg:w-[80rem] relative flex flex-col items-center justify-center"> <!-- Added relative class -->
        <button class="absolute top-0 right-0 mt-4 mr-4 border rounded-full bg-white text-orange-600 border-orange-600 w-32 md:w-52 md:text-lg"> <!-- Adjusted position using absolute class and added margin -->
            <a href="{{route('donor-new-pet')}}">Add Your Pet</a>
        </button>
        <a href="#"><div class="bg-white shadow appearance-none border rounded h-14 w-44 flex flex-row items-center justify-center space-x-4">
            <img src="{{asset('Images/dogavatar.jpg')}}" alt="" class="h-10 w-10">
            <p class="text-sm font-bold">Liza</p>
        </div></a>
    </div>
</div>
